      ...
      <form className='bg-white p-6 rounded-b-lg border border-black-200'>
        <div className='flex flex-col md:flex-row gap-8 p-4'>
          ...
          <div className="flex-1">
            ...
            <label htmlFor="CategoryName" className='block font-bold mb-2'>Sub Category Name</label>
            <select className='rounded-lg border border-gray-300 w-full h-12 p-3 font-medium mb-6' name="ParentCategoryName" id="CategoryName">
              <option value="">Select Category</option>
              <option value="men">Men</option>
              <option value="women">Women</option>
            ...
            <label htmlFor="CategoryOrder" className='block font-bold mb-2'>Category Name</label>
            <input
              type="text"
              id="CategoryOrder"
              name="CategoryOrder"
