  ...
  return (
    <section>
      <div className='mt-5'>
        ...
        <h1 className='font-semibold p-4 text-xl text-gray-400'> <span><Link to={"/dashboard"} className='hover:text-blue-900'>Home</Link> / <Link to={"/viewcolor"} className='hover:text-blue-900'>Color</Link> / View</span></h1>
      ...
      <div className='flex flex-col md:flex-row bg-[#F1F5F9] px-2 rounded-lg border border-black-200 items-center justify-between mt-9 py-4'>
        <h1 className='text-3xl font-semibold mb-3 ms-2'>View Color</h1>
        ...
        <table className="min-w-full rounded-lg table-fixed">
          <thead>
            <tr className='bg-[#374151] text-white'>
              ...
              <th className="px-4 py-5 text-left bg-[#374151] w-1 z-10 ">COLOR NAME</th>
              <th className="px-4 py-5 text-center w-1/6">CODE</th>
          ...
          <tbody>
            {[1, 2].map((row, i) => (
              ...
              >
                ...
                <td className="px-4 py-2 align-middle text-center w-1/8">#er33rv</td>
