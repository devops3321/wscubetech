  ...
  return (
    <section>
      <div className='mt-5'>
        ...
        <h1 className='font-semibold p-4 text-xl text-gray-400'> <span><Link to={"/dashboard"} className='hover:text-blue-900'>Home</Link> / <Link to={"/slider/add"} className='hover:text-blue-900'>Slider</Link> / Add</span></h1>
      ...
      <div className='flex flex-col md:flex-row bg-[#F1F5F9] px-2 rounded-t-lg border border-black-200 items-center justify-between mt-9 py-4'>
        <h1 className='text-3xl font-semibold mb-3 ms-2'>Add Slider</h1>
      </div>
      <form className='bg-white p-6 rounded-b-lg border border-black-200'>
        <div className='flex flex-col md:flex-row gap-8 p-4'>
          {/* Slider Image */}
          <div className="flex-1">
            <label htmlFor="SliderImage" className='block font-bold mb-2'>Choose Image</label>
            <div
              id="sliderDropzone"
              ref={dropzoneRef}
          ...
          {/* Slider Title & Order */}
          <div className="flex-1">
            <label htmlFor="SliderTitle" className='block font-bold mb-2'>Slider Title</label>
            <input
              type="text"
              id="SliderTitle"
              name="SliderTitle"
              ...
              required
            />
            <label htmlFor="SliderOrder" className='block font-bold mb-2'>Order</label>
            <input
              type="text"
              id="SliderOrder"
              name="SliderOrder"
        ...
        <button type="submit" className="mt-4 text-white bg-purple-700 hover:bg-purple-800 font-medium rounded-lg text-sm ms-4 px-5 py-2.5">Add Slider</button>
      </form>
      </div>
    </section>
  );
